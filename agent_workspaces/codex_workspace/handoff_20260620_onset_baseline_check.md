...
- Review onset_baseline_report.md and inclusion_decision_note.md before deciding whether to add this experiment to the paper.
- If final paper inclusion is desired, rerun with larger or uncapped evaluation settings and then update LaTeX manually in a separate task.
